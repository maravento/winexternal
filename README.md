...
**WinExternal** is a project that compiles various essential offline packages for Windows into one silent unattended launcher

**WinExternal** es un proyecto que recopila varios paquetes esenciales fuera de línea para Windows en un lanzador desatendido y silencioso

## DATA SHEET

---

[![Image](https://raw.githubusercontent.com/maravento/winexternal/master/img/download.png)](https://mega.nz/file/mAlWyaIJ#EF-d5499M_9crCZ8DPnd4AFCwPOtmPDLmTDUOBdRftw)

|File|OS|Size|
| :---: | :---: | :---: |
|WinExternal.exe (.zip)|Windows 7/8/10/11 x86 x64|809,4 MB|
...
- .NET Framework v4.8.1 Standalone Installation Package for Windows 10/11 (20H2 or Later - EN/SP) / Paquete independiente de instalación de .NET Framework v4.8.1 para Windows 10/11 (20H2 o Superior - EN/ES)

#### Important About .NET Framework v4.8.1
...
- .NET 6.0 Desktop Runtime (6.0.8.31518) x86 x64 Run Desktop Apps
...
- WebView2 Runtime Installer X86 X64 - 104.0.1263.54
